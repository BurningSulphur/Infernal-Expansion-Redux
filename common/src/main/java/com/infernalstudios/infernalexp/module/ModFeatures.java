...
public class ModFeatures {
    ...
    public static ResourceKey<Feature<?>> register(String name, Feature<?> feature) {
        return register(ResourceKey.create(Registries.FEATURE, IECommon.id(name)), feature);
    }

    public static ResourceKey<Feature<?>> register(ResourceKey<Feature<?>> id, Feature<?> feature) {
